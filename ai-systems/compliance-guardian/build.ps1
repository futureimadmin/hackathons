# Build script for Compliance Guardian Lambda deployment package
# Creates a deployment.zip file with all dependencies

Write-Host "Building Compliance Guardian Lambda deployment package..." -ForegroundColor Green
...
Write-Host "   aws lambda update-function-code --function-name compliance-guardian --zip-file fileb://deployment.zip" -ForegroundColor Gray
